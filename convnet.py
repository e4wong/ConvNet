...
def main():
    ...
    test_X, test_Y = load_both_shape_data("test_easy_shape_dataset", "test_hard_shape_dataset")
    test_X = torch.from_numpy(test_X).float()
    test_Y = torch.from_numpy(test_Y).long()
    print(len(test_X), len(test_Y))

    print("Training Easy")
    (easy_training_accuracy, easy_test_accuracy) = train(easy_X, easy_Y, easy_net, train_X, train_Y, test_X, test_Y)
    print("Training Hard")
    (hard_training_accuracy, hard_test_accuracy) = train(hard_X, hard_Y, hard_net, train_X, train_Y, test_X, test_Y)
    print("Training Random")
    (random_training_accuracy, random_test_accuracy) = train(train_X, train_Y, random_net, train_X, train_Y, test_X, test_Y)
